...
- **Event command text, other log entry**:
  ...
  - **Log entry text** or **Event CMD** = label shown in blue, when the text field contains any general log entry, such as a record of how a Dynamic Variable token was replaced and what real value was used. 
