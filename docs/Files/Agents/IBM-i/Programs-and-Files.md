...
|              |     were replaced by program temporary fixes (PTFs)  |
...
|              | library is used by all LSAM environments to store    |
...
-   **LMMSGID**: The message ID that the LSAM should recognize, e.g.,
    CPF1241.
