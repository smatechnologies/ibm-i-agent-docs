...
description of how to use the logging features, refer to [Log File and Database Management](/logs-database/overview)
.
...
to [Log File and Database Management](/logs-database/overview)
